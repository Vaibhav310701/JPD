            ...
            <div className="w-[90%] mx-auto flex flex-col gap-4 pt-6">
                ...
                <div className="flex gap-2 justify-start font-semibold items-center text-[14px]">
                  ...
                  >
                    <input
                      ...
                      name="lookingTo"
                      value="Sale"
                      checked={formData.property_details.looking_to === "Sale"}
                      onChange={(e) =>
                  ...
                  >
                    <input
                      ...
                      name="lookingTo"
                      value="rent"
                      checked={formData.property_details.looking_to === "rent"}
                      onChange={(e) =>
                        handlePropertyChange("looking_to", e.target.value)
                      }
                      className="hidden"
                ...
                <div className="flex gap-2 flex-wrap justify-start items-center font-semibold text-[14px]">
                  <button
                    ...
                    className={`px-4 py-2 border border-[#CBC7FA]  text-sm rounded-md transition-all duration-200 ease-in-out ${
                      formData.property_details.property_type === "Residential"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.property_details.property_type === "Commercial"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.property_details.property_type === "Agriculture"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-wrap gap-2 justify-start items-center text-[14px]">
                        <button
                          ...
                          className={`px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                            formData.property_details.selected_type === "Flat"
                              ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                              : "bg-white text-[#7F8393]"
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                            formData.property_details.selected_type === "Villa"
                              ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                              : "bg-white text-[#7F8393]"
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                            formData.property_details.selected_type === "Plot"
                              ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                              : "bg-white text-[#7F8393]"
                          }`}
                        >
                            ...
                            <div className="flex flex-wrap gap-2 font-semibold justify-start items-center text-[14px]">
                              {[
                                ...
                                <label
                                  key={index}
                                  className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                                    formData.property_details.selected_bhk ===
                                    bhk
                                      ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                                      : "bg-white text-[#7F8393]"
                                  }`}
                                >
                                  <input
                                    ...
                                    onChange={() => {
                                      handlePropertyChange("selected_bhk", bhk);
                                    }}
                                    className="hidden"
                                  />
                                  {bhk}
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              <div className="flex items-center border border-[#CBC7FA]  rounded-md">
                                <input
                                  ...
                                  value={formData.property_details.carpet_area}
                                  onChange={(e) => {
                                    handlePropertyChange(
                                      "carpet_area",
                                      e.target.value
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              <div className="flex items-center border border-[#CBC7FA]  rounded-md">
                                <input
                                  ...
                                  className="w-[200px] px-4 py-2 text-[14px] outline-none  rounded-md "
                                  value={
                                    formData.property_details.construction_area
                                  }
                                  onChange={(e) => {
                                    handlePropertyChange(
                                      "construction_area",
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col gap-2 text-[14px]">
                      ...
                      <div className="flex flex-wrap gap-4 text-[14px] font-semibold">
                        ...
                        <label
                          className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                            formData.property_details.selected_type === "Shop"
                              ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                              : "bg-white text-[#7F8393]"
                          }`}
                        >
                        ...
                        <label
                          className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                            formData.property_details.selected_type === "Shade"
                              ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                              : "bg-white text-[#7F8393]"
                          }`}
                        >
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col gap-2 text-[14px] font-semibold">
                      ...
                      <div className="flex flex-wrap gap-4 text-[14px] font-semibold">
                        ...
                        <label
                          className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                            formData.property_details.selected_type === "Land"
                              ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                              : "bg-white text-[#7F8393]"
                          }`}
                        >
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <div className="flex items-center border border-[#CBC7FA]  rounded-md">
                            <input
                              ...
                              value={formData.property_details.breadth}
                              onChange={(e) => {
                                handlePropertyChange("breadth", e.target.value);
                              }}
                              className="w-[200px] px-4 py-2 text-[14px] outline-none  rounded-md "
                            />
                            <select className="px-4 py-2 text-[14px]  outline-none rounded-r-md bg-[#E0DEF7] text-[#7065F0]">
              ...
              <div className="flex flex-col gap-2 text-[14px] font-semibold">
                ...
                <div className="flex flex-wrap gap-4 font-semibold text-[14px]">
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_facing === "North-East"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_facing === "North-West"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_facing === "South-East"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_facing === "South-West"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
              ...
              <div className="flex flex-col gap-2 text-[14px] font-semibold">
                ...
                <div className="flex flex-wrap gap-4 text-[14px]">
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_road === "30ft road"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                    <input
                      ...
                      onChange={(e) => {
                        handleLocationDetails("selected_road", e.target.value);
                      }}
                      className="hidden"
                    />
                    30ft road
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_road === "40ft road"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_road === "60ft road"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_road === "80ft road"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_road === "100ft road"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_road === "200ft road"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
              ...
              <div className="flex flex-col gap-2 text-[14px] font-semibold">
                ...
                <div className="flex flex-wrap gap-4 text-[14px]">
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_placing === "Corner"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
                  ...
                  <label
                    className={`cursor-pointer px-4 py-2 border border-[#CBC7FA] rounded-md transition-all duration-200 ease-in-out ${
                      formData.location_details.selected_placing === "Middle"
                        ? "bg-[#E0DEF7] text-[#7065F0] border border-[#CBC7FA]-[#CBC7FA]"
                        : "bg-white text-[#7F8393]"
                    }`}
                  >
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[14px] font-medium">Longitude</label>
                  <input
                    type="text"
