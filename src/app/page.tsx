...
export default function Home() {
  ...
  return (
    <div className="h-full w-full ">
      ...
      <div className="h-[calc(100%-54px)] bg-gradient-to-b from-[#E0DEF7] to-transparent w-full gap-8 flex flex-col md:flex-col lg:flex-row overflow-auto relative">
          ...
          <div className="flex flex-col items-center md:items-center lg:items-start gap-3 w-[80%] lg:w-[70%] md:[85%] m-auto">
            ...
            <div className="pt-8">
              ...
              >
                ...
                <div className="">
                  <button className="rounded-md bg-[#7065F0] hover:bg-[#5f52f3] font-semibold px-3 py-2 text-white">
                    Browse Property
                  </button>
                </div>
              </div>
